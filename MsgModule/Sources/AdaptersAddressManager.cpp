...
namespace net
{
	...
	AdaptersAddressManager* AdaptersAddressManager::Instance()
	{
		static AdaptersAddressManager manager;
		return &manager;
	}

	AdaptersAddressManager::AdaptersAddressManager()
	{
		Initialization();
	}
	...
	void AdaptersAddressManager::Initialization()
	{
		WSAStartupHolder wsaHolder(MAKEWORD(2, 2));
	...
	std::vector<std::wstring> AdaptersAddressManager::GetLocalAddresses() const
	{
		return m_localAddress;
	}

	std::wstring AdaptersAddressManager::GetAppropriateAddress() const
	{
